...
<div class = "container" id="wrapper">
    ...
    <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li class="sidebar-brand">
                    <a id="menu-toggle" style="float:right;" > <i class="fa fa-bars "></i> 
                    </a>
                </li>
    ...
    <script>
      ...
      const rect1 = new fabric.Rect({left: 100, top: 100, fill: 'red', width: 50, height: 50 });
      const rect2 = new fabric.Rect({left: 300, top: 200, fill: 'green', width: 50, height: 50 });
