...
@section('content')
                    ...
                    <div class="isiCard">
                        ...
                        <div class="usable">
                            ...
                            <div class="selection my-3 my-sm-5">
                                ...
                                <select name="hint" id="hint" class="form-control selectpicker bordered"
                                    data-live-search="true" tabindex="-1" aria-label="hint">
                                    <option value="-" selected disabled>-- Pilih Hint --</option>
                                    @foreach ($hints as $hint)
                                        <option value="{{ $hint->idhints }}" data-tokens="{{ $hint->name }}">
                                            {{ $hint->name }}</option>
                                    @endforeach
                                </select>
                            </div>
    ...
    <script>
        ...
        $("#btnAdd").click(function() {
            ...
            } else if ($("#hint").val() == null) {
                $("#alert-warning").html("Tolong pilih Hint terlebih dahulu")
                $("#ModalAlert").modal("show")
            } else {
