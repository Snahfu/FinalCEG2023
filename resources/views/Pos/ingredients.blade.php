                    ...
                    <div class="isiCard">
                        ...
                        <div class="usable">
                            ...
                            <div class="selection my-3 my-sm-5">
                                ...
                                <select name="bahan" id="bahan" class="form-control selectpicker bordered" data-live-search="true" tabindex="-1" aria-label="bahan">
                                    <option value="-" selected disabled>-- Pilih Bahan --</option>
                                    @foreach ($bahan as $b)
                                        <option value="{{ $b->nama_bahan }}" data-tokens="{{ $b->nama_bahan }}">{{ $b->nama_bahan }}</option>
                                    @endforeach
